...
# Title: Top Block
# Generated: Wed Mar  8 18:34:56 2017
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._samp_rate_range = Range(32E3, 25E6, 1E6, 25E6, 200)
        ...
        self.uhd_usrp_source_1.set_center_freq(797E6, 0)
        self.uhd_usrp_source_1.set_gain(gain, 0)
        self.uhd_usrp_source_1.set_bandwidth(012.56, 0)
        self._signal_range = Range(698E6, 3.55E9, 1E6, 800E6, 200)
        self._signal_win = RangeWidget(self._signal_range, self.set_signal, "signal", "counter_slider", float)
        self.top_layout.addWidget(self._signal_win)
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_float*1, '/home/user/Dropbox/College/Senior Year/Capstone/test', False)
